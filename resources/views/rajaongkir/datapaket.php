...
$origin = 37;//PURBALINGGA CITY, HARDCODED BECAUSE FIRMOS IS IN PBG
curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS => "origin=".$origin."&destination=".$distrik."&weight=".$berat."&courier=".$ekspedisi,
    CURLOPT_HTTPHEADER => array(
        "content-type: application/x-www-form-urlencoded",
        "key: e64c1caf1b713ae802132a61d4b0bf45"
    ),
));
