															...
															<tr>
																...
																>
																	<div align="center" class="alignment" style="line-height: 10px">
																		<img
																			alt="Company Logo"
																			src="{{ asset('images/firmos-logo.png') }}"
																			style="
																				display: block;
																				height: auto;
																				border: 0;
																...
																>
																	<div align="center" class="alignment" style="line-height: 10px">
																		<img
																			...
																			class="big"
																			src="{{ asset('images/round_corner_top.png') }}"
																			style="
																				display: block;
																				height: auto;
																				border: 0;
																	...
																	<div style="font-family: sans-serif">
																		...
																		>
																			...
																			<p
																				...
																				"
																			>
																				Kami mendapatkan permintaan untuk mengatur ulang
																				password Anda.
																			</p>
																		</div>
																	</div>
																...
																<td class="pad">
																	<div align="center" class="alignment" style="line-height: 10px">
																		<img
																			...
																			src="{{ asset('images/password_reset.png') }}"
																			style="
																				display: block;
																				height: auto;
																				border: 0;
																	...
																	<div style="font-family: sans-serif">
																		...
																		>
																			<p
																				...
																				"
																			>
																				Jika Anda mengabaikan pesan ini, maka password Anda
																				tidak akan terubah. Jika Anda tidak melakukan
																				permintaan atur ulang password, hubungi kami.
																			</p>
																		</div>
																	</div>
																</td>
																...
																>
																	<div align="center" class="alignment" style="line-height: 10px">
																		<img
																			...
																			class="big"
																			src="{{ asset('images/round_corner_bottom.png') }}"
																			style="
																				display: block;
																				height: auto;
																				border: 0;
																		...
																		>
																			<tr>
																				<td style="padding: 0 2px 0 2px">
																					<a
																						href="https://instagram.com/firmos_cv"
																						target="_blank"
																						><img
																							alt="Instagram"
																							height="32"
																							src="{{ asset('images/instagram2xmono.png') }}"
																							style="
																								display: block;
																								height: auto;
																								border: 0;
